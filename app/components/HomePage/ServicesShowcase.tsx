...
const ServicesShowcase = forwardRef<HTMLDivElement, ServicesShowcaseProps>(
  ({ services, cardsContainerRef, cardsRef }, ref) => {
    ...
    // Center the modal on the cursor logic
    useGSAP(() => {
    ...
    useEffect(() => {
      const handleMouseMove = (e: MouseEvent) => {
        if (isHovering && mounted) {
            moveModalTo(e.clientX, e.clientY, 0.8);
        }
      };
    ...
    return (
      <div
        ref={ref}
        className="services-wrapper relative w-full flex-col px-1 py-2 md:px-0 md:py-0"
      >
          {/* --- FLOATING IMAGE CARD (PORTAL) --- */}
          ...
          <section className="flex flex-col w-full">
            ...
            {/* 1. SERVICES BANNER IMAGE (Top Div) */}
            ...
            <div className="flex flex-col w-full mt-10 md:mt-20">
                ...
                {services.map((service, index) => (
                    ...
                    onMouseEnter={(e) => {
                        ...
                        setIsHovering(true);
                        moveModalTo(e.clientX, e.clientY, 0.1); 
                    }}
                    ...
                    <div className="relative z-10 flex w-full items-center justify-between gap-4">
                        ...
                        <span className="font-beckman text-3xl text-neutral-600 transition-colors duration-300 group-hover:text-white md:text-6xl">
